...
// Plugin to limit fields in toJSON call.
// original toJSON method is renamed to fullJSON
// sauce: https://github.com/nkzawa/mongoose-json-select
...
exports = module.exports = function (schema, fields) {
	...
	methods.toJSON = function (options) {
		var schemaOptions = this.schema.options.toJSON,
			_options = options || schemaOptions || { virtuals: true },
		...
		var obj = toJSON.call(this, _options);
