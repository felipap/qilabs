...
window.calcTimeFrom=function(o){var e=new Date,t=new Date(o),r=e-t;if(!(6e4>r)){if(36e5>r){var a=Math.floor(r/1e3/60);return"há "+a+" minuto"+(a>1?"s":"")}if(108e6>r){var a=Math.floor(r/1e3/60/60);return"há "+a+" hora"+(a>1?"s":"")}if(12096e5>r){var a=Math.floor(r/1e3/60/60/24);return"há "+a+" dia"+(a>1?"s":"")}var a=Math.floor(r/1e3/60/60/24/7);return"há "+a+" semana"+(a>1?"s":"")}return"agora";var a};var $=require("jquery"),modernizr=require("modernizr"),plugins=require("./plugins.js"),bootstrap_tooltip=require("../vendor/bootstrap/tooltip.js"),bootstrap_button=require("../vendor/bootstrap/button.js"),bootstrap_dropdown=require("../vendor/bootstrap/dropdown.js"),bell=require("./components/bell.js");$("body").tooltip({selector:"[data-toggle=tooltip]"}),$("[data-toggle=dialog]").xdialog(),$(".btn").button(),function(){$.ajaxPrefilter(function(o,e,t){o.crossDomain||t.setRequestHeader("X-CSRF-Token",$("meta[name='csrf-token']").attr("content"))})}(),$(document).mouseup(function(o){var e=$("#sidebarPanel");$("body").hasClass("sidebarOpen")&&(e.is(o.target)||0!==e.has(o.target).length||$("#openSidebar").is(o.target)||0!==$("#openSidebar").has(o.target).length||$("body").removeClass("sidebarOpen"))}),$(document).on("click","#openSidebar",function(){$("body").toggleClass("sidebarOpen")}),$("body").on("click",".btn-follow",function(){var o=this.dataset.action;if("follow"!==o&&"unfollow"!==o)throw"What?";var e="follow"===o?"unfollow":"follow";$.post("/api/users/"+this.dataset.user+"/"+o,function(o){o.error?alert(o.error):this.dataset.action=e}.bind(this))}),$("body").on("click","[data-trigger=component]",function(o){o.preventDefault();var e=this.dataset;if($("body").removeClass("sidebarOpen"),e.route){var t=$(this).data("href")||$(this).attr("href");t&&console.warn("Component href attribute is set to "+t+"."),app.navigate(t,{trigger:!0,replace:!1})}else{if("undefined"==typeof app||!app.components)return void(e.href?window.location.href=e.href:console.error("Can't trigger component "+app.page+" in unexistent app object."));if(e.component in app.components){var r={};if(e.args)try{r=JSON.parse(e.args)}catch(o){console.error("Failed to parse data-args "+e.args+" as JSON object."),console.error(o.stack)}app.components[e.component].call(app,r)}else console.warn("Router doesn't contain component "+e.component+".")}}),$("a[data-ajax-post-href],button[data-ajax-post-href]").click(function(){var o=this.dataset.ajaxPostHref,e=this.dataset.redirectHref;$.post(o,function(){e?window.location.href=e:window.location.reload()})});
...
var $=require("jquery"),_=require("underscore"),React=require("react"),bootstrap_tooltip=require("bootstrap.tooltip"),bootstrap_popover=require("bootstrap.popover");$.extend($.fn.popover.Constructor.DEFAULTS,{react:!1});var oldSetContent=$.fn.popover.Constructor.prototype.setContent;if($.fn.popover.Constructor.prototype.setContent=function(){if(!this.options.react)return oldSetContent.call(this);var t=this.tip(),e=this.getTitle(),n=this.getContent();if(t.removeClass("fade top bottom left right in"),!t.find(".popover-content").html()){var o=t.find(".popover-title");e?React.renderComponent(e,o[0]):o.hide(),React.renderComponent(n,t.find(".popover-content")[0])}},window.user){var Notification=React.createClass({displayName:"Notification",handleClick:function(){var t=this;t.props.data.accessed?window.location.href=t.props.data.url:$.ajax({url:"/api/me/notifications/"+this.props.data.id+"/access",data:{see:!0},type:"get",datatType:"json"}).done(function(){window.location.href=t.props.data.url})},render:function(){var t={backgroundImage:"url("+this.props.data.thumbnailUrl+")"},e=window.calcTimeFrom(this.props.data.dateSent);return React.DOM.li({className:"notificationItem","data-seen":this.props.data.seen,"data-accessed":this.props.data.accessed,onClick:this.handleClick},this.props.data.thumbnailUrl?React.DOM.div({className:"thumbnail",style:t}):void 0,React.DOM.div({className:"notificationItemBody"},React.DOM.span({dangerouslySetInnerHTML:{__html:this.props.data.msgHtml}}),React.DOM.time(null,e)))}}),NotificationList=React.createClass({displayName:"NotificationList",render:function(){var t=this.props.data.map(function(t){return Notification({key:t.id,data:t})});return React.DOM.div({className:"notificationList"},t,React.DOM.li({className:"action",onClick:this.props.destroy,"data-trigger":"component","data-component":"notifications"},"Ver +"))}}),Bell=React.createClass({displayName:"Bell",componentWillMount:function(){this.seen=!1;var t=this;$(document).mouseup(function(e){var n=$(t.refs.button.getDOMNode());n.is(e.target)||0!==n.has(e.target).length||0!==$(e.target).parents(".popover.in").length||$(t.refs.button.getDOMNode()).popover("hide")}),this.getNotifications()},getNotifications:function(){$.ajax({url:"/api/me/notifications",type:"get",dataType:"json"}).done(function(t){{var e=_.all(t.data,function(t){return t.seen});_.all(t.data,function(t){return t.accessed})}e?($(this.getDOMNode()).removeClass("nonempty"),this.refs.nCount.getDOMNode().innerHTML="0"):($(this.getDOMNode()).addClass("nonempty"),this.refs.nCount.getDOMNode().innerHTML=_.filter(t.data,function(t){return!t.seen}).length),e?$(this.getDOMNode()).removeClass("active"):$(this.getDOMNode()).addClass("active"),$("[data-info=unseen-notifs]").html(_.filter(t.data,function(t){return!t.seen}).length),$("[data-info=unseen-notifs]").addClass(e?"zero":"nonzero"),this.seen=!e;var n=function(){$(this.refs.button.getDOMNode()).popover("destroy")}.bind(this);$(this.refs.button.getDOMNode()).popover({react:!0,content:NotificationList({data:t.data,destroy:n}),placement:"bottom",container:"nav.bar",trigger:"manual"})}.bind(this)).always(function(){}.bind(this))},onClickBell:function(){var t=$(this.refs.button.getDOMNode());this.seen||(this.seen=!0,$.post("/api/me/notifications/seen"),this.refs.nCount.getDOMNode().innerHTML="0"),t.popover(t.data("bs.popover")&&t.data("bs.popover").tip().hasClass("in")?"hide":"show")},render:function(){return React.DOM.button({ref:"button",className:"icon-btn bell","data-action":"show-notifications",onClick:this.onClickBell},React.DOM.i({className:"icon-bell2"}),React.DOM.sup({ref:"nCount",className:"count"},"0"))}});document.getElementById("nav-bell")&&React.renderComponent(Bell(null),document.getElementById("nav-bell"))}
},{"bootstrap.popover":21,"bootstrap.tooltip":22,"jquery":23,"react":26,"underscore":28}],3:[function(require,module,exports){
var $=require("jquery"),Backbone=require("backbone"),_=require("underscore"),React=require("react"),FlashDiv=React.createClass({displayName:"FlashDiv",getInitialState:function(){return{message:"",action:""}},message:function(e,s,t){var i=this.refs.message.getDOMNode();$(i).fadeOut(function(){function n(){setTimeout(function(){$(this).fadeOut()}.bind(this),t||5e3)}$(this.refs.messageContent.getDOMNode()).html(e),$(i).prop("class","message "+s).fadeIn("fast",n)}.bind(this))},hide:function(){$(this.refs.message.getDOMNode()).fadeOut()},render:function(){return React.DOM.div({ref:"message",className:"message",style:{display:"none"},onClick:this.hide},React.DOM.span({ref:"messageContent"})," ",React.DOM.i({className:"close-btn",onClick:this.hide}))}});module.exports=function(){this.fd=React.renderComponent(FlashDiv(null),$("<div id='flash-wrapper'>").appendTo("body")[0]),this.warn=function(e,s){this.fd.message(e,"warn",s||5e3)},this.info=function(e,s){this.fd.message(e,"info",s||5e3)},this.alert=function(e,s){this.fd.message(e,"error",s||5e3)}};
},{"backbone":18,"jquery":23,"react":26,"underscore":28}],4:[function(require,module,exports){
function trim(e){return e.replace(/(^\s+)|(\s+$)/gi,"")}function pureText(e){return e.replace(/(<([^>]+)>)/gi,"")}var $=require("jquery"),_=require("underscore"),Backbone=require("backbone"),React=require("react");Backbone.$=$;var GenericPostItem=Backbone.Model.extend({url:function(){return this.get("apiPath")},constructor:function(){Backbone.Model.apply(this,arguments),this.get("votes")&&(this.liked=!!~this.get("votes").indexOf(user.id))}}),ProblemItem=GenericPostItem.extend({url:function(){return this.get("apiPath")},handleToggleVote:function(){var e=this;$.ajax({type:"post",dataType:"json",url:this.get("apiPath")+(this.liked?"/unupvote":"/upvote")}).done(function(t){console.log("response",t),t.error||(e.liked=!e.liked,t.data.author&&delete t.data.author,e.set(t.data),e.trigger("change"))})},initialize:function(){var e=this.get("children")||{};this.children={},this.children.Answer=new ChildrenCollections.Answer(e.Answer),this.children.Comment=new ChildrenCollections.Comment(e.Comment)}}),PostItem=GenericPostItem.extend({url:function(){return this.get("apiPath")},validate:function(e){var t=trim(e.content.title).replace("\n","");if(t.length<10)return"Esse título é muito pequeno.";if(t.length>100)return"Esse título é muito grande.";var n=e.content.body;return n?n.length>2e4?"Ops. Texto muito grande.":pureText(n).length<20?"Ops. Texto muito pequeno.":void 0:"Escreva um corpo para a sua publicação."},handleToggleVote:function(){var e=this;$.ajax({type:"post",dataType:"json",url:this.get("apiPath")+(this.liked?"/unupvote":"/upvote")}).done(function(t){console.log("response",t),t.error||(e.liked=!e.liked,t.data.author&&delete t.data.author,e.set(t.data),e.trigger("change"))})},initialize:function(){var e=this.get("children")||{};this.children={},this.children.Answer=new ChildrenCollections.Answer(e.Answer),this.children.Comment=new ChildrenCollections.Comment(e.Comment)}}),FeedList=Backbone.Collection.extend({model:PostItem,constructor:function(e,t){Backbone.Collection.apply(this,arguments),this.url=t.url,this.EOF=!1,this.on("remove",function(){console.log("removed!")}),this.on("add",function(){console.log("addd!")}),this.on("update",function(){console.log("updated!")})},comparator:function(e){return-1*new Date(e.get("created_at"))},parse:function(e,t){e.minDate<1&&(this.EOF=!0,this.trigger("statusChange")),this.minDate=1*new Date(e.minDate);var n=Backbone.Collection.prototype.parse.call(this,e.data,t);return _.filter(n,function(e){return!!e})},tryFetchMore:function(){console.log("fetch more"),this.minDate<1||this.fetch({data:{maxDate:this.minDate-1},remove:!1})}}),CommentItem=GenericPostItem.extend({validate:function(e){var t=e.content.body;return t.length<=3?"Seu comentário é muito pequeno.":t.length>=1e3?"Seu comentário é muito grande.":void 0}}),AnswerItem=PostItem.extend({}),ChildrenCollections={Answer:Backbone.Collection.extend({model:AnswerItem,comparator:function(e){return-e.get("voteSum")},comparators:{votes:function(e){return-e.get("voteSum")},older:function(e){return 1*new Date(e.get("created_at"))},younger:function(e){return-1*new Date(e.get("created_at"))},updated:function(e){return-1*new Date(e.get("updated"))}}}),Comment:Backbone.Collection.extend({model:CommentItem,endDate:new Date,comparator:function(e){return 1*new Date(e.get("created_at"))},url:function(){return this.postItem.get("apiPath")+"/comments"},parse:function(e,t){return this.endDate=new Date(e.endDate),Backbone.Collection.prototype.parse.call(this,e.data,t)}})};module.exports={postItem:PostItem,problemItem:ProblemItem,answerItem:AnswerItem,commentItem:CommentItem,feedList:FeedList};
},{"backbone":18,"jquery":23,"react":26,"underscore":28}],5:[function(require,module,exports){
var $=require("jquery"),Backbone=require("backbone"),_=require("underscore"),models=require("./models.js"),React=require("react"),MediumEditor=require("medium-editor");require("typeahead-bundle");var mediumEditorPostOpts={firstHeader:"h1",secondHeader:"h2",buttons:["bold","italic","underline","header1","header2","quote","anchor","orderedlist"],buttonLabels:{quote:'<i class="icon-quote-left"></i>',orderedlist:'<i class="icon-list"></i>',anchor:'<i class="icon-link"></i>'}},tagData=_.map(tagMap,function(e,t){return{id:t,name:e.name,detail:e.detail}}),tagStates=new Bloodhound({datumTokenizer:Bloodhound.tokenizers.obj.whitespace("name"),queryTokenizer:Bloodhound.tokenizers.whitespace,local:tagData});tagStates.initialize();var TagSelectionBox=React.createClass({displayName:"TagSelectionBox",getInitialState:function(){return{selectedTagsIds:this.props.children||[]}},addTag:function(e){-1===this.state.selectedTagsIds.indexOf(e)&&this.setState({selectedTagsIds:this.state.selectedTagsIds.concat(e)}),this.props.onChangeTags()},removeTag:function(e){var t=this.state.selectedTagsIds.indexOf(e);if(-1!==t){var a=this.state.selectedTagsIds;a.splice(t,1),this.setState({selectedTagsIds:a})}this.props.onChangeTags()},popTag:function(){var e=this.state.selectedTagsIds;e.length&&(e.pop(),console.log("new",e),this.setState({selectedTagsIds:e})),this.props.onChangeTags()},getSelectedTagsIds:function(){return this.state.selectedTagsIds},componentDidMount:function(){$(this.refs.input.getDOMNode()).typeahead({highlight:!0,hint:!0},{name:"tag",source:tagStates.ttAdapter(),templates:{empty:['<div class="empty-message">Assunto não encontrado</div>'].join("\n"),suggestion:_.template('<div><label><%= name %></label><div class="detail"><%= detail %></div></div>')}});var e=this;$(this.getDOMNode()).on("click focusin focus",function(){$(e.getDOMNode()).addClass("focused"),$("#tagInput").focus(),$(e.getDOMNode()).find(".placeholder").hide()}),$(this.refs.input.getDOMNode()).on("focusout",function(){$("#tagSelectionBox").removeClass("focused"),_.defer(function(){$(e.refs.input.getDOMNode()).val("")})}).on("keydown",function(t){var a=t.keyCode||t.charCode;8==a&&t.target.value.match(/^\s*$/)&&e.popTag()});var e=this;$(this.refs.input.getDOMNode()).on("typeahead:selected",function(t,a){e.addTag(a.id)})},render:function(){var e=this,t=_.map(this.state.selectedTagsIds,function(t){return React.DOM.li({className:"tag",key:t},React.DOM.span(null,this.props.data[t].name),React.DOM.span({onClick:function(){e.removeTag(t)}},React.DOM.i({className:"close-btn"})))}.bind(this));return React.DOM.div({className:t.length?"":" empty ",id:"tagSelectionBox"},React.DOM.i({className:"iconThumbnail iconThumbnailSmall icon-tags"}),React.DOM.ul(null,t.length?t:React.DOM.div({className:"placeholder"},this.props.placeholder)),React.DOM.input({ref:"input",type:"text",id:"tagInput"}))}}),PostEdit=React.createClass({displayName:"PostEdit",componentDidMount:function(){var e=this;$(this.getDOMNode().parentElement).on("click",function s(t){(t.target===this||t.target===e.getDOMNode())&&(e.close(),$(this).unbind("click",s))}),$("body").addClass("crop");var t=this.refs.postBody.getDOMNode(),a=this.refs.postTitle.getDOMNode();this.editor=new MediumEditor(t,mediumEditorPostOpts),window.e=this.editor,$(t).mediumInsert({editor:this.editor,addons:{images:{}}}),$(e.refs.postBodyWrapper.getDOMNode()).on("click",function(t){t.target==e.refs.postBodyWrapper.getDOMNode()&&$(e.refs.postBody.getDOMNode()).focus()}),$(a).on("input keyup keypress",function(e){if(13==(e.keyCode||e.charCode))return e.preventDefault(),void e.stopPropagation();var t=this.refs.postTitle.getDOMNode().value;this.props.model.get("content").title=t}.bind(this)),_.defer(function(){$(a).autosize()})},componentWillUnmount:function(){this.editor.deactivate(),$(this.editor.anchorPreview).remove(),$(this.editor.toolbar).remove(),$(this.refs.postTitle.getDOMNode()).trigger("autosize.destroy"),$("body").removeClass("crop")},onChangeTags:function(){this.props.model.set("tags",this.refs.tagSelectionBox.getSelectedTagsIds())},onClickSend:function(){this.props.model.set("type",this.refs.typeSelect.getDOMNode().value),this.props.model.set("subject",this.refs.subjectSelect.getDOMNode().value),this.props.model.attributes.content.body=this.editor.serialize().postBody.value,this.props.model.save(void 0,{url:this.props.model.url()||"/api/posts",success:function(e){window.location.href=e.get("path"),app.flash.info("Publicação salva! :)")},error:function(e,t){var a=t.responseJSON;app.flash.alert(a&&a.message?a.message:"Milton Friedman.")}})},close:function(){("+Img"===$(this.refs.postBody.getDOMNode()).text()||confirm("Deseja descartar permanentemente as suas alterações?"))&&this.props.page.destroy()},render:function(){return React.DOM.div({className:"postBox"},React.DOM.i({className:"close-btn","data-action":"close-page",onClick:this.close}),React.DOM.div({className:"formWrapper"},React.DOM.div({className:"flatBtnBox"},React.DOM.div({className:"item send",onClick:this.onClickSend,"data-toggle":"tooltip",title:"Enviar","data-placement":"right"},React.DOM.i({className:"icon-paper-plane"})),React.DOM.div({className:"item save",onClick:"","data-toggle":"tooltip",title:"Salvar rascunho","data-placement":"right"},React.DOM.i({className:"icon-save"})),React.DOM.div({className:"item help",onClick:"","data-toggle":"tooltip",title:"Ajuda?","data-placement":"right"},React.DOM.i({className:"icon-question"}))),React.DOM.div({id:"formCreatePost"},React.DOM.div({className:"category-select-wrap"},React.DOM.span(null,"Essa publicação é uma "),React.DOM.select({ref:"typeSelect",className:"form-control"},React.DOM.option({value:"Discussion"},"Discussão"),React.DOM.option({value:"Note"},"Nota"))),React.DOM.div({className:"subject-select-wrap"},React.DOM.span(null,"Assunto"),React.DOM.select({ref:"subjectSelect",className:"form-control"},React.DOM.option({value:"mathematics"},"Matemática"),React.DOM.option({value:"application"},"Application"))),TagSelectionBox({ref:"tagSelectionBox",placeholder:"Tópicos Relacionados",onChangeTags:this.onChangeTags,data:_.indexBy(tagData,"id")},this.props.model.get("tags")),React.DOM.textarea({ref:"postTitle",className:"title",name:"post_title",placeholder:"Sobre o que você quer falar?",defaultValue:this.props.model.get("content").title}),React.DOM.div({className:"bodyWrapper",ref:"postBodyWrapper"},React.DOM.div({id:"postBody",ref:"postBody","data-placeholder":"",dangerouslySetInnerHTML:{__html:(this.props.model.get("content")||{body:""}).body}})))))}}),PostCreationView=React.createClass({displayName:"PostCreationView",render:function(){return this.postModel=new models.postItem({author:window.user,content:{title:"",body:""}}),PostEdit({ref:"postForm",model:this.postModel,page:this.props.page})}}),ProblemEdit=React.createClass({displayName:"ProblemEdit",componentDidMount:function(){var e=this;_.defer(function(){$(this.refs.sendBtn.getDOMNode()).tooltip("show"),setTimeout(function(){$(this.refs.sendBtn.getDOMNode()).tooltip("hide")}.bind(this),2e3)}.bind(this)),$(this.getDOMNode().parentElement).on("click",function s(t){(t.target===this||t.target===e.getDOMNode())&&(e.close(),$(this).unbind("click",s))}),$("body").addClass("crop");var t=this.refs.postBody.getDOMNode(),a=this.refs.postTitle.getDOMNode();this.editor=new MediumEditor(t,mediumEditorPostOpts),$(t).mediumInsert({editor:this.editor,addons:{}}),$(a).on("input keyup keypress",function(e){return 13==(e.keyCode||e.charCode)?(e.preventDefault(),void e.stopPropagation()):void 0}.bind(this)),_.defer(function(){$(a).autosize()})},componentWillUnmount:function(){this.editor.deactivate(),$(this.editor.anchorPreview).remove(),$(this.editor.toolbar).remove(),$(this.refs.postTitle.getDOMNode()).trigger("autosize.destroy"),$("body").removeClass("crop")},onChangeTags:function(){this.props.model.set("tags",this.refs.tagSelectionBox.getSelectedTagsIds())},onClickSend:function(){this.props.model.attributes.content.body=this.editor.serialize().postBody.value,this.props.model.attributes.content.source=this.refs.postSource.getDOMNode().value,this.props.model.attributes.content.title=this.refs.postTitle.getDOMNode().value,this.props.model.attributes.content.answer={is_mc:!0,options:[this.refs["right-ans"].getDOMNode().value,this.refs["wrong-ans1"].getDOMNode().value,this.refs["wrong-ans2"].getDOMNode().value,this.refs["wrong-ans3"].getDOMNode().value,this.refs["wrong-ans3"].getDOMNode().value]},this.props.model.save(void 0,{url:this.props.model.url()||"/api/problems",success:function(e){window.location.href=e.get("path"),app.flash.info("Publicação salva! :)")},error:function(e,t){var a=t.responseJSON;app.flash.alert(a&&a.message?a.message:"Milton Friedman.")}})},close:function(){("+Img"===$(this.refs.postBody.getDOMNode()).text()||confirm("Deseja descartar permanentemente as suas alterações?"))&&this.props.page.destroy()},render:function(){return React.DOM.div({className:"postBox"},React.DOM.i({className:"close-btn","data-action":"close-page",onClick:this.close}),React.DOM.div({className:"form-wrapper"},React.DOM.div({className:"form-side-btns"},React.DOM.div({className:"item send",ref:"sendBtn",onClick:this.onClickSend,"data-toggle":"tooltip",title:"Enviar Problema","data-placement":"right"},React.DOM.i({className:"icon-paper-plane"})),React.DOM.div({className:"item save",onClick:"","data-toggle":"tooltip",title:"Salvar rascunho","data-placement":"right"},React.DOM.i({className:"icon-save"})),React.DOM.div({className:"item help",onClick:"","data-toggle":"tooltip",title:"Ajuda?","data-placement":"right"},React.DOM.i({className:"icon-question"}))),React.DOM.header(null,React.DOM.i({className:"icon-measure"}),React.DOM.label(null,"Compartilhe um problema"),React.DOM.ul({className:"right"})),React.DOM.section({className:"textInputs"},React.DOM.textarea({ref:"postTitle",className:"title",name:"post_title",placeholder:"Dê um título legal para o seu problema",defaultValue:this.props.model.get("content").title}),React.DOM.div({className:"bodyWrapper",ref:"postBodyWrapper"},React.DOM.div({id:"postBody",ref:"postBody","data-placeholder":"Descreva um problema interessante para os seus seguidores.",dangerouslySetInnerHTML:{__html:(this.props.model.get("content")||{body:""}).body}})),React.DOM.div({className:"image-dropin"},React.DOM.label(null,"Adicione uma imagem ao seu problema")),React.DOM.input({type:"text",ref:"postSource",className:"source",name:"post_source",placeholder:"Cite a fonte desse problema (opcional)",defaultValue:this.props.model.get("content").source})),React.DOM.section({className:"selectOptions"},React.DOM.div({className:"left"}),React.DOM.div({className:"right"},React.DOM.div({className:"answer-input"},React.DOM.ul({className:"answer-input-list"},React.DOM.input({className:"right-ans",ref:"right-ans",type:"text",placeholder:"A resposta certa"}),React.DOM.input({className:"wrong-ans",ref:"wrong-ans1",type:"text",placeholder:"Uma opção incorreta"}),React.DOM.input({className:"wrong-ans",ref:"wrong-ans2",type:"text",placeholder:"Uma opção incorreta"}),React.DOM.input({className:"wrong-ans",ref:"wrong-ans3",type:"text",placeholder:"Uma opção incorreta"}),React.DOM.input({className:"wrong-ans",ref:"wrong-ans4",type:"text",placeholder:"Uma opção incorreta"}))))),React.DOM.footer(null,TagSelectionBox({ref:"tagSelectionBox",placeholder:"Assuntos",onChangeTags:this.onChangeTags,data:_.indexBy(tagData,"id")},this.props.model.get("tags")))))}});module.exports={create:PostCreationView,edit:PostEdit,problem:ProblemEdit};
...
var $=require("jquery"),Backbone=require("backbone"),_=require("underscore"),models=require("./models.js"),React=require("react"),MediumEditor=require("medium-editor"),mediumEditorAnswerOpts={firstHeader:"h1",secondHeader:"h2",buttons:["bold","italic","quote","anchor","underline","orderedlist"],buttonLabels:{quote:'<i class="icon-quote"></i>',orderedlist:'<i class="icon-list"></i>',anchor:'<i class="icon-link"></i>'}},EditablePost={onClickTrash:function(){confirm("Tem certeza que quer excluir permanentemente essa publicação?")&&this.props.model.destroy()}},backboneCollection={componentWillMount:function(){var e=function(){this.forceUpdate(function(){})};this.props.collection.on("add reset change remove",e.bind(this))}},backboneModel={componentWillMount:function(){var e=function(){this.forceUpdate(function(){})};this.props.model.on("add reset remove change",e.bind(this))}},Comment={View:React.createClass({displayName:"View",mixins:[EditablePost],render:function(){function e(e){return e.length>50?"..."+/https?:(?:\/\/)?[A-Za-z0-9][A-Za-z0-9\-]*([A-Za-z0-9\-]{2}\.[A-Za-z0-9\.\-]+(\/.{0,20})?)/.exec(e)[1]+"...":e}function t(t){var a=/(((https?:(?:\/\/)?)(?:www\.)?[A-Za-z0-9\.\-]+)((?:\/[\+~%\/\.\w\-_]*)?\??(?:[\-\+=&;%@\.\w_]*)#?(?:[\.\!\/\\\w]*))?)/;return t.replace(a,function(t){return'<a href="'+t+'">'+e(t)+"</a>"})}var a=this.props.model.attributes,s={background:"url("+a.author.avatarUrl+")"},o=t(a.content.body);return React.DOM.div({className:"commentWrapper"},React.DOM.div({className:"msgBody"},React.DOM.div({className:"arrow"}),React.DOM.span({dangerouslySetInnerHTML:{__html:o}})),React.DOM.div({className:"infoBar"},React.DOM.a({className:"userLink author",href:a.author.path},React.DOM.div({className:"avatarWrapper"},React.DOM.div({className:"avatar",style:s,title:a.author.username})),React.DOM.span({className:"name"},a.author.name))," · ",React.DOM.time({"data-time-count":1*new Date(a.created_at)},window.calcTimeFrom(a.created_at)),window.user&&window.user.id===a.author.id?React.DOM.div({className:"optionBtns"},React.DOM.button({"data-action":"remove-post",onClick:this.onClickTrash},React.DOM.i({className:"icon-trash-o"}))):void 0))}}),InputForm:React.createClass({displayName:"InputForm",getInitialState:function(){return{showInput:!1}},componentDidUpdate:function(){var e=this;this.refs&&this.refs.input&&(this.refs.input.getDOMNode().focus(),$(this.refs.input.getDOMNode()).autosize(),this.props.small&&$(this.refs.input.getDOMNode()).keyup(function(t){13==t.keyCode?t.preventDefault():27==t.keyCode&&e.refs.input.getDOMNode().value.match(/^\s*$/)&&e.setState({showInput:!1})}),$(this.refs.input.getDOMNode()).keyup(function(){if(e.refs.input){var t=e.refs.input.getDOMNode().value.length,a=e.refs.count.getDOMNode();a.innerHTML=t,t?1e3>t?$(a).removeClass("empty ilegal"):$(a).addClass("ilegal"):$(a).addClass("empty").removeClass("ilegal")}}))},showInput:function(){this.setState({showInput:!0})},handleSubmit:function(e){e.preventDefault();var t=$(this.refs.input.getDOMNode()),a=this;$.ajax({type:"post",dataType:"json",url:this.props.model.get("apiPath")+"/comments",data:{content:{body:t.val()}}}).done(function(e){e.error?app.flash.alert(e.message||"Erro!"):(a.setState({showInput:!1}),t.val(""),a.props.model.children.Comment.add(new models.commentItem(e.data)))}).fail(function(e){app.flash.alert(e.responseJSON.message||"Erro!")})},render:function(){if(!window.user)return React.DOM.div(null);({background:"url("+window.user.avatarUrl+")"});return React.DOM.div(null,this.state.showInput?React.DOM.div({className:"commentInputSection "+(this.props.small?"small":"")},React.DOM.form({className:"formPostComment",onSubmit:this.handleSubmit},React.DOM.textarea({required:"required",ref:"input",type:"text",placeholder:"Seu comentário aqui..."}),React.DOM.button({"data-action":"send-comment",onClick:this.handleSubmit},"Enviar"),React.DOM.span({className:"count",ref:"count"},"0"))):React.DOM.div({className:"showInput",onClick:this.showInput},"Answer"===this.props.model.get("type")?"Adicionar comentário.":"Fazer comentário."))}}),ListView:React.createClass({displayName:"ListView",mixins:[backboneCollection],render:function(){var e=this.props.collection.map(function(e){return CommentView({model:e,key:e.id})});return React.DOM.div({className:"commentList"},this.props.small?null:React.DOM.label(null,this.props.collection.models.length," Comentário",this.props.collection.models.length>1?"s":""),e)}}),SectionView:React.createClass({displayName:"SectionView",mixins:[backboneCollection],render:function(){return this.props.collection?React.DOM.div({className:"commentSection "+(this.props.small?" small ":"")},CommentListView({small:this.props.small,placeholder:this.props.placeholder,collection:this.props.collection}),CommentInputForm({small:this.props.small,model:this.props.postModel})):React.DOM.div(null)}})},Answer={View:React.createClass({displayName:"View",mixins:[backboneModel,EditablePost],getInitialState:function(){return{isEditing:!1}},onClickEdit:function(){this.editor&&(this.setState({isEditing:!0}),this.editor.activate())},componentDidMount:function(){window.user&&this.props.model.get("author").id===window.user.id?(this.editor=new MediumEditor(this.refs.answerBody.getDOMNode(),mediumEditorAnswerOpts),$(this.refs.answerBody.getDOMNode()).mediumInsert({editor:this.editor,addons:{}}),this.editor.deactivate()):this.editor=null},onClickSave:function(){if(this.editor){var e=this;this.props.model.save({content:{body:this.editor.serialize()["element-0"].value}},{success:function(){e.setState({isEditing:!1}),e.forceUpdate()}})}},componentWillUnmount:function(){this.editor&&(this.editor.deactivate(),$(this.editor.anchorPreview).remove(),$(this.editor.toolbar).remove())},componentDidUpdate:function(){this.editor&&(this.state.isEditing?this.editor.activate():(this.editor.deactivate(),$(this.refs.answerBody.getDOMNode()).html($(this.props.model.get("content").body))))},toggleVote:function(){this.props.model.handleToggleVote()},onCancelEdit:function(){this.editor&&this.setState({isEditing:!1})},render:function(){var e=this.props.model.attributes,t=window.user&&-1!=e.votes.indexOf(window.user.id),a=window.user&&e.author.id===window.user.id,s=React.DOM.div({className:" voteControl "+(t?"voted":"")},React.DOM.button({className:"thumbs",onClick:this.toggleVote,disabled:a?"disabled":"",title:a?"Você não pode votar na sua própria resposta.":""},React.DOM.i({className:"icon-thumbs-o-up"})),React.DOM.div({className:"count"},e.voteSum));return React.DOM.div({className:"answerViewWrapper"},React.DOM.div({className:" answerView "+(this.state.isEditing?" editing ":""),ref:"answerView"},React.DOM.div({className:"left"},s),React.DOM.div({className:"right"},React.DOM.div({className:"answerBodyWrapper",ref:"answerBodyWrapper"},React.DOM.div({className:"answerBody",ref:"answerBody",dangerouslySetInnerHTML:{__html:e.content.body}})),React.DOM.div({className:"infobar"},React.DOM.div({className:"toolbar"},a?React.DOM.div({className:"item save","data-action":"save-post",onClick:this.onClickSave,"data-toggle":"tooltip","data-placement":"bottom",title:"Salvar"},React.DOM.i({className:"icon-paper-plane"})):null,a?React.DOM.div({className:"item cancel",onClick:this.onCancelEdit,"data-toggle":"tooltip","data-placement":"bottom",title:"Cancelar"},React.DOM.i({className:"icon-times"})):null,a?React.DOM.div({className:"item edit",onClick:this.onClickEdit,"data-toggle":"tooltip","data-placement":"bottom",title:"Editar"},React.DOM.i({className:"icon-pencil"})):null,a?React.DOM.div({className:"item remove","data-action":"remove-post",onClick:this.onClickTrash,"data-toggle":"tooltip","data-placement":"bottom",title:"Remover"},React.DOM.i({className:"icon-trash-o"})):null,React.DOM.div({className:"item share","data-toggle":"tooltip","data-placement":"bottom",title:"Link"},React.DOM.i({className:"icon-share-alt"})),React.DOM.div({className:"item flag","data-toggle":"tooltip","data-placement":"bottom",title:"Sinalizar conteúdo"},React.DOM.i({className:"icon-flag"}))),React.DOM.div({className:"answerAuthor"},React.DOM.div({className:"avatarWrapper"},React.DOM.a({href:e.author.path},React.DOM.div({className:"avatar",style:{background:"url("+e.author.avatarUrl+")"},title:e.author.username}))),React.DOM.div({className:"info"},React.DOM.a({href:e.author.path,className:"username"},e.author.name)," ",React.DOM.time({"data-time-count":1*new Date(e.created_at)},window.calcTimeFrom(e.created_at)))))),CommentSectionView({small:!0,collection:this.props.model.children.Comment,postModel:this.props.model})))}}),ListView:React.createClass({displayName:"ListView",componentWillMount:function(){var e=function(){this.forceUpdate(function(){})};this.props.collection.on("add reset remove",e.bind(this))},render:function(){var e=this.props.collection.map(function(e){return AnswerView({model:e,key:e.id})});return React.DOM.div({className:"answerList"},e)}}),SectionView:React.createClass({displayName:"SectionView",mixins:[backboneCollection],getInitialState:function(){return{sortingType:"votes"}},onSortSelected:function(e){var t=e.target.dataset.sort;console.log(e,t);var a=this.props.collection.comparators[t];this.props.collection.comparator=a,this.props.collection.sort(),this.setState({sortingType:t})},render:function(){var e=this,t={votes:"Votos",older:"+ Antigo",younger:"+ Novo",updated:"Atividade"},a=_.map(_.filter(_.keys(t),function(t){return t!=e.state.sortingType}),function(a){return React.DOM.li({"data-sort":a,onClick:e.onSortSelected},t[a])}),s=React.DOM.div({className:"menu"},React.DOM.span({className:"selected","data-sort":this.state.sortingType},t[this.state.sortingType],React.DOM.i({className:"icon-chevron-down"})),React.DOM.div({className:"dropdown"},a));return React.DOM.div({className:"answerSection"},this.props.collection.length?React.DOM.div({className:"sectionHeader"},React.DOM.label(null,this.props.collection.length," Resposta",1==this.props.collection.length?"":"s"),React.DOM.div({className:"sortingMenu"},React.DOM.label(null,"ordenar por"),s)):React.DOM.div({className:"sectionHeader"},React.DOM.label(null,"0 respostas")),AnswerListView({collection:this.props.collection}),AnswerInputForm({model:this.props.postModel,placeholder:"Adicionar comentário."}))}}),InputForm:React.createClass({displayName:"InputForm",componentDidUpdate:function(){this.refs&&this.refs.input&&(this.editor=new MediumEditor(this.refs.input.getDOMNode(),mediumEditorAnswerOpts))},getInitialState:function(){return{showInput:!1}},handleSubmit:function(e){if(e.preventDefault(),!this.editor)return alert("WTF");var t=this.editor.serialize()["element-0"].value,a=this;$.ajax({type:"post",dataType:"json",url:this.props.model.get("apiPath")+"/answers",data:{content:{body:t}}}).done(function(e){a.editor.innerHTML="",a.setState({showInput:!1}),console.log("response",e),a.props.model.children.Answer.add(new models.answerItem(e))}).fail(function(e){app.flash.alert(e.message?e.message:"Erro!")})},showInput:function(){this.props.model.children.Answer.all(function(e){return e.get("author").id!=window.user.id})?this.setState({showInput:!0}):app.flash.warn("Você não pode responder à mesma pergunta mais de uma vez. Edite a sua resposta antiga se quiser adicionar mais informações.")},render:function(){if(!window.user)return React.DOM.div(null);({background:"url("+window.user.avatarUrl+")"});return React.DOM.div(null,this.state.showInput?React.DOM.div({className:"answerInputSection "+(this.props.small?"small":"")},React.DOM.form({className:"formPostAnswer",onSubmit:this.handleSubmit},React.DOM.div({className:"editorWrapper"},React.DOM.div({className:"editor answerBody",ref:"input",name:"teste","data-placeholder":"Responda à pergunta '"+this.props.model.get("content").title+"'' de forma clara. Não se esqueça de citar fontes externas, se você as usar para chegar na resposta."})),React.DOM.button({"data-action":"send-answer",onClick:this.handleSubmit},"Enviar"))):React.DOM.div({className:"showInput",onClick:this.showInput},"Responder pergunta."))}})},PostHeader=React.createClass({displayName:"PostHeader",mixins:[EditablePost],render:function(){var e=this.props.model.attributes,t=window.user&&e.author.id===window.user.id,a=null;return window.user&&!t&&e._meta&&"undefined"!=typeof e._meta.authorFollowed&&(a=React.DOM.button(e._meta.authorFollowed?{className:"btn-follow","data-action":"unfollow","data-user":e.author.id}:{className:"btn-follow","data-action":"follow","data-user":e.author.id})),React.DOM.div({className:"postHeader"},React.DOM.div({className:"type"},e.translatedType),React.DOM.div({className:"tags"},React.DOM.div({className:"tags"},_.map(e.tags,function(e){return"undefined"==typeof tagMap[e]?null:React.DOM.a({href:tagMap[e].path,className:"tag",key:e},"#",tagMap[e].name)}))),React.DOM.div({className:"postTitle"},e.content.title),React.DOM.time(null," publicado ",React.DOM.span({"data-time-count":1*new Date(e.created_at)},window.calcTimeFrom(e.created_at)),e.updated_at&&1*new Date(e.updated_at)>1*new Date(e.created_at)?React.DOM.span(null,", ",React.DOM.span({"data-toggle":"tooltip",title:window.calcTimeFrom(e.updated_at)},"editado")):null),React.DOM.div({className:"authorInfo"},"por  ",React.DOM.div({className:"avatarWrapper"},React.DOM.div({className:"avatar",style:{background:"url("+e.author.avatarUrl+")"}})),React.DOM.a({href:e.author.path,className:"username"},e.author.name),a),t?React.DOM.div({className:"flatBtnBox"},React.DOM.div({className:"item edit",onClick:this.props.parent.onClickEdit},React.DOM.i({className:"icon-pencil"})),React.DOM.div({className:"item remove",onClick:this.props.parent.onClickTrash},React.DOM.i({className:"icon-trash-o"})),React.DOM.div({className:"item share",onClick:this.props.parent.onClickLink},React.DOM.i({className:"icon-share-alt"})),React.DOM.div({className:"item watch",onClick:this.props.parent.onClickWatch},React.DOM.i({className:"icon-eye"}))):React.DOM.div({className:"flatBtnBox"},React.DOM.div({className:"item like "+(window.user&&-1!=e.votes.indexOf(window.user.id)?"liked":""),onClick:this.props.parent.toggleVote},React.DOM.i({className:"icon-heart-o"}),React.DOM.span({className:"count"},e.voteSum)),React.DOM.div({className:"item share",onClick:this.props.parent.onClickLink},React.DOM.i({className:"icon-share-alt"})),React.DOM.div({className:"item watch",onClick:this.props.parent.onClickWatch},React.DOM.i({className:"icon-eye"})),React.DOM.div({className:"item flag",onClick:this.props.parent.onClickFlag},React.DOM.i({className:"icon-flag"}))))}}),ProblemHeader=React.createClass({displayName:"ProblemHeader",mixins:[EditablePost],render:function(){var e=this.props.model.attributes,t=window.user&&e.author.id===window.user.id,a=null;return window.user&&!t&&e._meta&&"undefined"!=typeof e._meta.authorFollowed&&(a=React.DOM.button(e._meta.authorFollowed?{className:"btn-follow","data-action":"unfollow","data-user":e.author.id}:{className:"btn-follow","data-action":"follow","data-user":e.author.id})),React.DOM.div({className:"header"},t?React.DOM.div({className:"flatBtnBox"},React.DOM.div({className:"item edit",onClick:this.props.parent.onClickEdit},React.DOM.i({className:"icon-pencil"})),React.DOM.div({className:"item remove",onClick:this.props.parent.onClickTrash},React.DOM.i({className:"icon-trash-o"})),React.DOM.div({className:"item share",onClick:this.props.parent.onClickLink},React.DOM.i({className:"icon-share-alt"})),React.DOM.div({className:"item watch",onClick:this.props.parent.onClickWatch},React.DOM.i({className:"icon-eye"}))):React.DOM.div({className:"flatBtnBox"},React.DOM.div({className:"item like "+(window.user&&-1!=e.votes.indexOf(window.user.id)?"liked":""),onClick:this.props.parent.toggleVote},React.DOM.i({className:"icon-heart-o"}),React.DOM.span({className:"count"},e.voteSum)),React.DOM.div({className:"item share",onClick:this.props.parent.onClickLink},React.DOM.i({className:"icon-share-alt"})),React.DOM.div({className:"item watch",onClick:this.props.parent.onClickWatch},React.DOM.i({className:"icon-eye"})),React.DOM.div({className:"item flag",onClick:this.props.parent.onClickFlag},React.DOM.i({className:"icon-flag"}))))}}),CommentSectionView=Comment.SectionView,CommentListView=Comment.ListView,CommentInputForm=Comment.InputForm,CommentView=Comment.View,AnswerSectionView=Answer.SectionView,AnswerListView=Answer.ListView,AnswerInputForm=Answer.InputForm,AnswerView=Answer.View;module.exports={Discussion:React.createClass({mixins:[EditablePost,backboneModel],render:function(){{var e=this.props.model.attributes;window.user&&e.author.id===window.user.id}return React.DOM.div({className:"postCol"},PostHeader({model:this.props.model,parent:this.props.parent}),React.DOM.div({className:"postBody",dangerouslySetInnerHTML:{__html:this.props.model.get("content").body}}),React.DOM.div({className:"postInfobar"},React.DOM.ul({className:"left"})),React.DOM.div({className:"postFooter"},CommentSectionView({collection:this.props.model.children.Comment,postModel:this.props.model,small:!0}),AnswerSectionView({collection:this.props.model.children.Answer,postModel:this.props.model})))}}),Problem:React.createClass({mixins:[EditablePost,backboneModel],tryAnswer:function(e){var t=parseInt(e.target.dataset.index);console.log("User clicked",t,this.props.model.get("apiPath")+"/try"),$.ajax({type:"post",dataType:"json",url:this.props.model.get("apiPath")+"/try",data:{test:t}}).done(function(e){e.error?app.flash.alert(e.message||"Erro!"):app.flash.info(e.result?"Because you know me so well.":"WROOOOOOOOOONNNG, YOU IMBECILE!")}).fail(function(e){app.flash.alert(e.responseJSON&&e.responseJSON.message||"Erro!")})},render:function(){{var e=this.props.model.attributes;window.user&&e.author.id===window.user.id}console.log(e.content.answer);var t=e.content.source,a=t&&!!t.match(/(^\[adaptado\])|(adaptado)/);return React.DOM.div({className:"postCol question"},React.DOM.div({className:"contentCol"},React.DOM.div({className:"body-window"},React.DOM.div({className:"breadcrumbs"}),React.DOM.div({className:"body-window-content"},React.DOM.div({className:"title"},e.content.title),React.DOM.div({className:"postBody",dangerouslySetInnerHTML:{__html:this.props.model.get("content").body}})),React.DOM.div({className:"sauce"},a?React.DOM.span({className:"detail"},"adaptado"):null,t?t:null)),React.DOM.div({className:"fixed-footer"},React.DOM.div({className:"user-avatar"},React.DOM.div({className:"avatar",style:{background:"url("+e.author.avatarUrl+")"}})),React.DOM.div({className:"info"},"Por ",React.DOM.a({href:e.author.path},e.author.name),", 14 anos, Brazil"),React.DOM.div({className:"actions"},React.DOM.button({className:""},React.DOM.i({className:"icon-thumbsup"})," 23"),React.DOM.button({className:""},React.DOM.i({className:"icon-retweet2"})," 5")))),React.DOM.div({className:"rightCol"},React.DOM.div({className:"answer-col-mc"},React.DOM.ul(null,React.DOM.li(null,React.DOM.button({onClick:this.tryAnswer,"data-index":"0",className:"right-ans"},e.content.answer.options[0])),React.DOM.li(null,React.DOM.button({onClick:this.tryAnswer,"data-index":"1",className:"wrong-ans"},e.content.answer.options[1])),React.DOM.li(null,React.DOM.button({onClick:this.tryAnswer,"data-index":"2",className:"wrong-ans"},e.content.answer.options[2])),React.DOM.li(null,React.DOM.button({onClick:this.tryAnswer,"data-index":"3",className:"wrong-ans"},e.content.answer.options[3])),React.DOM.li(null,React.DOM.button({onClick:this.tryAnswer,"data-index":"4",className:"wrong-ans"},e.content.answer.options[4]))))))}}),Note:React.createClass({mixins:[EditablePost,backboneModel],render:function(){this.props.model.attributes;return React.DOM.div({className:"postCol"},React.DOM.div(null,PostHeader({model:this.props.model,parent:this.props.parent}),React.DOM.div({className:"postBody",dangerouslySetInnerHTML:{__html:this.props.model.get("content").body}}),React.DOM.div({className:"postInfobar"},React.DOM.ul({className:"left"})),React.DOM.div({className:"postFooter"},CommentSectionView({collection:this.props.model.children.Comment,postModel:this.props.model}))))}})};
},{"./models.js":4,"backbone":18,"jquery":23,"medium-editor":24,"react":26,"underscore":28}],7:[function(require,module,exports){
function createCookie(e,t,o){if(o){var s=new Date;s.setTime(s.getTime()+24*o*60*60*1e3);var i="; expires="+s.toGMTString()}else var i="";document.cookie=e+"="+t+i+"; path=/"}function readCookie(e){for(var t=e+"=",o=document.cookie.split(";"),s=0;s<o.length;s++){for(var i=o[s];" "==i.charAt(0);)i=i.substring(1,i.length);if(0===i.indexOf(t))return i.substring(t.length,i.length)}return null}function eraseCookie(e){createCookie(e,"",-1)}var $=require("jquery"),Backbone=require("backbone"),_=require("underscore"),React=require("react"),NotificationsPage=require("../pages/notifications.js"),FollowsPage=require("../pages/follows.js"),FullItem=require("../pages/fullItem.js"),ProfileView=require("../views/profile.js"),models=require("./models.js"),postViews=require("./postViews.js"),postForm=require("./postForm.js"),StreamView=require("./stream.js"),Flasher=require("./flash.js");setTimeout(function e(){$("[data-time-count]").each(function(){this.innerHTML=calcTimeFrom(parseInt(this.dataset.timeCount),this.dataset.timeLong)}),setTimeout(e,1e3)},1e3);var Page=function(e,t,o){var o=_.extend({},o||{onClose:function(){}});e.props.page=this;var s=document.createElement("div");this.e=s,this.c=e,o.navbar||$(s).addClass("pContainer"),$(s).addClass(o&&o.class||""),$(s).addClass("invisible").hide().appendTo("body"),t&&(s.dataset.page=t);var i=document.title;o.title&&(document.title=o.title),$("html").addClass(o.crop?"crop":"place-crop"),React.renderComponent(e,s,function(){$(s).show().removeClass("invisible")}),o.scrollable&&$(e.getDOMNode()).addClass("scrollable"),this.destroy=function(){$(s).addClass("invisible"),React.unmountComponentAtNode(s),$(s).remove(),document.title=i,$("html").removeClass(o.crop?"crop":"place-crop"),o.onClose&&(o.onClose(),o.onClose=void 0)}};$(".streamSetter").click(function(){var e=this.dataset.streamSource;app.fetchStream(e)});var WorkspaceRouter=Backbone.Router.extend({initialize:function(){console.log("initialized"),window.app=this,this.pages=[],this.renderWall(window.conf.postsRoot),$(document).scroll(_.throttle(function(){$(document).height()-($(window).scrollTop()+$(window).height())<50&&app.postList.tryFetchMore()},300))},flash:new Flasher,closePages:function(){for(var e=0;e<this.pages.length;e++)this.pages[e].destroy();this.pages=[]},fetchStream:function(e){var t={global:"/api/me/global/posts",inbox:"/api/me/inbox/posts",problems:"/api/me/problems"};if(e){if(!(e in t))throw"Something?";createCookie("qi.feed.source",e)}else e=readCookie("qi.feed.source",e)||"inbox";$(".streamSetter").removeClass("active"),$(".streamSetter[data-stream-source="+e+"]").addClass("active"),this.postList.url!==t[e]&&(this.postList.url=t[e],this.postList.reset(),this.postList.fetch({reset:!0}))},triggerComponent:function(e,t){e.call(this,t)},routes:{"@:username":function(e){console.log(e),ProfileView(this)},"posts/:postId":function(e){this.triggerComponent(this.components.viewPost,{id:e})},"posts/:postId/edit":function(e){this.triggerComponent(this.components.editPost,{id:e})},"problems/:problemId":function(e){this.triggerComponent(this.components.viewProblem,{id:e})},"problems/:problemId/edit":function(e){this.triggerComponent(this.components.editProblem,{id:e})},novo:function(){this.triggerComponent(this.components.createPost)},"novo-problema":function(){this.triggerComponent(this.components.createProblem)},"":function(){this.closePages()}},components:{viewPost:function(e){this.closePages();var t=e.id,o=window.conf.resource;if(o&&"post"===o.type&&o.data.id===t){var s=new models.postItem(o.data),i=new Page(FullItem({type:s.get("type"),model:s}),"post",{title:o.data.content.title,crop:!0,onClose:function(){app.navigate("/"),window.conf.resource=void 0}});this.pages.push(i)}else $.getJSON("/api/posts/"+t).done(function(e){if(e.data.parentPost)return app.navigate("/posts/"+e.data.parentPost,{trigger:!0});console.log("response, data",e);var t=new models.postItem(e.data),o=new Page(FullItem({type:t.get("type"),model:t}),"post",{title:t.get("content").title,crop:!0,onClose:function(){window.history.back()}});this.pages.push(o)}.bind(this)).fail(function(){app.flash.alert("Ops! Não conseguimos encontrar essa publicação. Ela pode ter sido excluída.")}.bind(this))},viewProblem:function(e){this.closePages();var t=e.id,o=window.conf.resource;if(o&&"problem"===o.type&&o.data.id===t){var s=new models.problemItem(o.data),i=new Page(FullItem({type:"Problem",model:s}),"post",{title:o.data.content.title,crop:!0,onClose:function(){app.navigate("/"),window.conf.resource=void 0}});this.pages.push(i)}else $.getJSON("/api/problems/"+t).done(function(e){if(e.data.parentPost)return app.navigate("/problems/"+e.data.parentPost,{trigger:!0});console.log("response, data",e);var t=new models.problemItem(e.data),o=new Page(FullItem({type:"Problem",model:t}),"post",{title:t.get("content").title,crop:!0,onClose:function(){window.history.back()}});this.pages.push(o)}.bind(this)).fail(function(){app.flash.alert("Ops! Não conseguimos encontrar essa publicação. Ela pode ter sido excluída.")}.bind(this))},createProblem:function(){this.closePages();var e=new models.postItem({author:window.user,content:{title:"",body:"",image:""}}),t=new Page(postForm.problem({user:window.user,model:e}),"problemForm",{crop:!0,onClose:function(){}});this.pages.push(t)},editProblem:function(e){this.closePages(),$.getJSON("/api/problems/"+e.id).done(function(e){console.log("response, data",e);var t=new models.problemItem(e.data),o=new Page(postForm.problem({model:t}),"problemForm",{crop:!0,onClose:function(){window.history.back()}});this.pages.push(o)}.bind(this)).fail(function(){alert("não achei")}.bind(this))},editPost:function(e){this.closePages(),$.getJSON("/api/posts/"+e.id).done(function(e){if(e.data.parentPost)return alert("eerrooo");console.log("response, data",e);var t=new models.postItem(e.data),o=new Page(postForm.edit({model:t}),"postForm",{crop:!0,onClose:function(){window.history.back()}});this.pages.push(o)}.bind(this)).fail(function(){alert("não achei")}.bind(this))},createPost:function(){this.closePages();var e=new Page(postForm.create({user:window.user}),"postForm",{crop:!0,onClose:function(){}});this.pages.push(e)},following:function(e){var t=e.id;$.getJSON("/api/users/"+t+"/following").done(function(e){e.error&&alert("vish fu");var t=new Page(FollowsPage({list:e.data,isFollowing:!0,profile:user_profile}),"listView",{navbar:!0,scrollable:!0});this.pages.push(t)}).fail(function(){alert("vish")})},followers:function(e){var t=e.id;$.getJSON("/api/users/"+t+"/followers").done(function(e){e.error&&alert("vish fu");var t=new Page(FollowsPage({list:e.data,isFollowing:!1,profile:user_profile}),"listView",{navbar:!0,scrollable:!0});this.pages.push(t)}).fail(function(){alert("vish")})},notifications:function(){this.closePages();var e=new Page(NotificationsPage(null),"notifications",{navbar:!1,crop:!1});this.pages.push(e)}},trigger:function(){},renderWall:function(e){(!this.postList||e&&this.postList.url!==e)&&(this.postList||(this.postList=new models.feedList([],{url:e})),this.postWall||(this.postWall=React.renderComponent(StreamView(null),document.getElementById("qi-stream-wrap")),this.postList.on("add update change remove reset statusChange",function(){this.postWall.forceUpdate(function(){})}.bind(this))),e?(this.postList.reset(),this.postList.url=e,this.postList.fetch({reset:!0})):app.fetchStream(),this.postList.fetch({reset:!0}))}});module.exports={initialize:function(){new WorkspaceRouter,Backbone.history.start({pushState:!0,hashChange:!1})}};
...
var $=require("jquery"),Backbone=require("backbone"),_=require("underscore"),models=require("./models.js"),React=require("react"),backboneModel={componentWillMount:function(){var a=function(){this.forceUpdate(function(){})};this.props.model.on("add reset remove change",a.bind(this))}},Card=React.createClass({displayName:"Card",mixins:[backboneModel],componentDidMount:function(){},render:function(){function a(){app.navigate(e.path,{trigger:!0})}var e=this.props.model.attributes,t={background:"url("+e.author.avatarUrl+")"},c=null;if(this.props.model.get("tag")){var s=this.props.model.get("tags")[0];s in tagMap&&(c=tagMap[s].name)}return React.DOM.div({className:"cardView",onClick:a},React.DOM.div({className:"cardHeader"},React.DOM.span({className:"cardType"},this.props.model.get()),React.DOM.div({className:"iconStats"},React.DOM.div({className:"stats-likes"},React.DOM.i(this.props.model.liked?{className:"icon-heart icon-red"}:{className:"icon-heart"})," ",e.voteSum),React.DOM.div({className:"stats-comments"},React.DOM.i({className:"icon-comments2"})," ",this.props.model.get("childrenCount").Comment))),React.DOM.div({className:"cardBody"},React.DOM.span({ref:"cardBodySpan"},e.content.title)),React.DOM.div({className:"cardFoot"},React.DOM.div({className:"authorship"},React.DOM.div({className:"avatarWrapper"},React.DOM.a({href:e.author.path},React.DOM.div({className:"avatar",style:t}))),React.DOM.a({href:e.author.path,className:"username"},e.author.name)),React.DOM.time({"data-time-count":1*new Date(e.created_at)},window.calcTimeFrom(e.created_at)),React.DOM.div({className:"iconStats"},React.DOM.div({className:"stats-comments"},React.DOM.span({className:"count"},this.props.model.get("childrenCount").Comment),React.DOM.i({className:"icon-chat2"})),React.DOM.div({className:this.props.model.liked?"stats-likes active":"stats-likes"},React.DOM.span({className:"count"},e.voteSum),React.DOM.i(this.props.model.liked?{className:"icon-heart"}:{className:"icon-heart2"})))),React.DOM.div({className:"veil"},React.DOM.time({"data-time-count":1*new Date(e.created_at)},window.calcTimeFrom(e.created_at))))}}),ListItem=React.createClass({displayName:"ListItem",mixins:[backboneModel],componentDidMount:function(){},render:function(){function a(){app.navigate(e.path,{trigger:!0})}{var e=this.props.model.attributes,t={background:"url("+e.author.avatarUrl+")"};React.DOM.div({className:"tags"},_.map(this.props.model.get("tags"),function(a){return React.DOM.div({className:"tag",key:a},"#",tagMap[a].name)}))}return React.DOM.div({className:"listItem",onClick:a},React.DOM.div({className:"cell lefty"},React.DOM.div({className:"item-col stats-col"},React.DOM.div({className:"stats-likes"},React.DOM.i(this.props.model.liked?{className:"icon-heart icon-red"}:{className:"icon-heart-o"}),React.DOM.span({className:"count"},e.voteSum))),React.DOM.div({className:"item-col stats-col"},React.DOM.div({className:"stats-comments"},React.DOM.i({className:"icon-comments2"}),React.DOM.span({className:"count"},this.props.model.get("childrenCount").Comment)))),React.DOM.div({className:"cell center"},React.DOM.div({className:"title"},React.DOM.span({ref:"cardBodySpan"},e.content.title)),React.DOM.div({className:"info-bar"},React.DOM.a({href:e.author.path,className:"username"},React.DOM.span({className:"pre"},"por")," ",e.author.name),React.DOM.i({className:"icon-circle"}),React.DOM.time({"data-time-count":1*new Date(e.created_at)},window.calcTimeFrom(e.created_at)))),React.DOM.div({className:"cell righty"},React.DOM.div({className:"item-col"},React.DOM.div({className:"user-avatar item-author-avatar"},React.DOM.a({href:e.author.path},React.DOM.div({className:"avatar",style:t}))))))}}),ProblemCard=React.createClass({displayName:"ProblemCard",mixins:[backboneModel],componentDidMount:function(){},render:function(){function a(){app.navigate(e.path,{trigger:!0})}{var e=this.props.model.attributes,t={background:"url("+e.author.avatarUrl+")"};React.DOM.div({className:"tags"},_.map(this.props.model.get("tags"),function(a){return React.DOM.div({className:"tag",key:a},"#",tagMap[a].name)}))}return React.DOM.div({className:"listItem",onClick:a},React.DOM.div({className:"cell lefty"},React.DOM.div({className:"item-col stats-col"},React.DOM.div({className:"stats-likes"},React.DOM.i(this.props.model.liked?{className:"icon-heart icon-red"}:{className:"icon-heart-o"}),React.DOM.span({className:"count"},e.voteSum)))),React.DOM.div({className:"cell center"},React.DOM.div({className:"title"},React.DOM.span({ref:"cardBodySpan"},e.content.title)),React.DOM.div({className:"info-bar"},React.DOM.a({href:e.author.path,className:"username"},React.DOM.span({className:"pre"},"por")," ",e.author.name),React.DOM.i({className:"icon-circle"}),React.DOM.time({"data-time-count":1*new Date(e.created_at)},window.calcTimeFrom(e.created_at)))),React.DOM.div({className:"cell righty"},React.DOM.div({className:"item-col"},React.DOM.div({className:"user-avatar item-author-avatar"},React.DOM.a({href:e.author.path},React.DOM.div({className:"avatar",style:t}))))))}}),FeedStreamView;module.exports=FeedStreamView=React.createClass({displayName:"FeedStreamView",getInitialState:function(){return{selectedForm:null}},componentWillMount:function(){},render:function(){var a=app.postList.map(function(a){if("Post"===a.get("__t"))return"ListView"===conf.streamRender?ListItem({model:a,key:a.id}):Card({model:a,key:a.id});if("Problem"==a.get("__t"))return ProblemCard({model:a,key:a.id});throw"Unrecognized post item."});return app.postList.length?React.DOM.div({className:"stream"},a):React.DOM.div({className:"stream"},React.DOM.div({className:"stream-msg"},"Ainda não há nada por aqui. Tente ",React.DOM.a({href:"/descubra/pessoas"},"seguir alguém"),", ou ",React.DOM.a({href:"/descubra/atividades"},"adicione interesses"),". ",React.DOM.i({className:"icon-happy"})))}});
},{"./models.js":4,"backbone":18,"jquery":23,"react":26,"underscore":28}],9:[function(require,module,exports){
var $=require("jquery"),models=require("../components/models.js"),React=require("react");module.exports=React.createClass({displayName:"exports",close:function(){this.props.page.destroy()},render:function(){var a=_.map(this.props.list,function(a){return React.DOM.li(null,React.DOM.a({href:a.path},React.DOM.div({className:"avatarWrapper"},React.DOM.div({className:"avatar",style:{background:"url("+a.avatarUrl+")"}})),React.DOM.span({className:"name"},a.name),window.user&&window.user.id!==a.id?React.DOM.button(a.meta.followed?{className:"btn-follow","data-action":"unfollow","data-user":a.id}:{className:"btn-follow","data-action":"follow","data-user":a.id}):null))});if(this.props.isFollowing)var e=this.props.profile.name+" segue "+this.props.list.length+" pessoas";else var e=this.props.list.length+" pessoas seguem "+this.props.profile.name;return React.DOM.div({className:"cContainer"},React.DOM.i({className:"close-btn",onClick:this.close}),React.DOM.div({className:"listWrapper"},React.DOM.div({className:"left"},React.DOM.button({"data-action":"close-page",onClick:this.close},"Voltar")),React.DOM.label(null,e),a))}});
},{"../components/models.js":4,"jquery":23,"react":26}],10:[function(require,module,exports){
var postViews=require("../components/postViews.js"),React=require("react");module.exports=React.createClass({displayName:"exports",componentWillMount:function(){var e=function(){this.forceUpdate(function(){})};this.props.model.on("add reset remove change",e.bind(this))},close:function(){this.props.page.destroy()},onClickEdit:function(){window.location.href=this.props.model.get("path")+"/edit"},onClickTrash:function(){confirm("Tem certeza que deseja excluir essa postagem?")&&(this.props.model.destroy(),this.close(),console.log("id being removed:",this.props.model.get("id")),app.postList.remove({id:this.props.model.get("id")}),$(".tooltip").remove())},toggleVote:function(){this.props.model.handleToggleVote()},componentDidMount:function(){var e=this;$(this.getDOMNode().parentElement).on("click",function t(o){(o.target===this||o.target===e.getDOMNode())&&(e.close(),$(this).unbind("click",t))})},render:function(){var e=this.props.model.attributes,t=(this.props.model.get("author"),this.props.type);if(!(t in postViews))return console.error("Couldn't find view for post of type "+t,e),React.DOM.div(null);var o=postViews[t];return React.DOM.div({className:"postBox","data-post-type":this.props.model.get("type"),"data-post-id":this.props.model.get("id")},React.DOM.i({className:"close-btn","data-action":"close-page",onClick:this.close}),o({model:this.props.model,parent:this}))}});
},{"../components/postViews.js":6,"react":26}],11:[function(require,module,exports){
var React=require("react"),NotificationsPage;module.exports=React.createClass({displayName:"exports",getInitialState:function(){return{notes:[]}},close:function(){this.props.page.destroy()},componentDidMount:function(){var e=this;$.ajax({url:"/api/me/notifications?limit=30",type:"get",dataType:"json"}).done(function(t){t.error?t.message&&app.flash.alert(t.message):e.setState({notes:t.data})})},render:function(){var e=_.map(this.state.notes,function(e){return React.DOM.li({className:"notification",key:e.id,"data-seen":e.seen,"data-accessed":e.accessed},React.DOM.img({className:"thumbnail",src:e.thumbnailUrl}),React.DOM.p({onClick:function(){window.location.href=e.url}},e.msg),React.DOM.time({"data-time-count":1*new Date(e.dateSent)},window.calcTimeFrom(e.dateSent)))});return React.DOM.div({className:"cContainer"},React.DOM.i({className:"close-btn",onClick:this.close}),React.DOM.ul({className:"notificationsWrapper"},e))}});
},{"react":26}],12:[function(require,module,exports){
var $=require("jquery");jQuery=$,function(t){var e,o={className:"autosizejs",id:"autosizejs",append:"",callback:!1,resizeDelay:10,placeholder:!0},i='<textarea tabindex="-1" style="position:absolute; top:-999px; left:0; right:auto; bottom:auto; border:0; padding: 0; -moz-box-sizing:content-box; -webkit-box-sizing:content-box; box-sizing:content-box; word-wrap:break-word; height:0 !important; min-height:0 !important; overflow:hidden; transition:none; -webkit-transition:none; -moz-transition:none;"/>',n=["fontFamily","fontSize","fontWeight","fontStyle","letterSpacing","textTransform","wordSpacing","textIndent"],a=t(i).data("autosize",!0)[0];a.style.lineHeight="99px","99px"===t(a).css("lineHeight")&&n.push("lineHeight"),a.style.lineHeight="",t.fn.autosize=function(i){return this.length?(i=t.extend({},o,i||{}),a.parentNode!==document.body&&t(document.body).append(a),this.each(function(){function o(){var e,o=window.getComputedStyle?window.getComputedStyle(h,null):!1;o?(e=h.getBoundingClientRect().width,(0===e||"number"!=typeof e)&&(e=parseInt(o.width,10)),t.each(["paddingLeft","paddingRight","borderLeftWidth","borderRightWidth"],function(t,i){e-=parseInt(o[i],10)})):e=Math.max(f.width(),0),a.style.width=e+"px"}function s(){var s={};if(e=h,a.className=i.className,a.id=i.id,c=parseInt(f.css("maxHeight"),10),t.each(n,function(t,e){s[e]=f.css(e)}),t(a).css(s).attr("wrap",f.attr("wrap")),o(),window.chrome){var r=h.style.width;h.style.width="0px",h.offsetWidth,h.style.width=r}}function r(){var t,n;e!==h?s():o(),a.value=!h.value&&i.placeholder?(f.attr("placeholder")||"")+i.append:h.value+i.append,a.style.overflowY=h.style.overflowY,n=parseInt(h.style.height,10),a.scrollTop=0,a.scrollTop=9e4,t=a.scrollTop,c&&t>c?(h.style.overflowY="scroll",t=c):(h.style.overflowY="hidden",d>t&&(t=d)),t+=p,n!==t&&(h.style.height=t+"px",b&&i.callback.call(h,h))}function l(){clearTimeout(u),u=setTimeout(function(){var t=f.width();t!==g&&(g=t,r())},parseInt(i.resizeDelay,10))}var c,d,u,h=this,f=t(h),p=0,b=t.isFunction(i.callback),w={height:h.style.height,overflow:h.style.overflow,overflowY:h.style.overflowY,wordWrap:h.style.wordWrap,resize:h.style.resize},g=f.width();f.data("autosize")||(f.data("autosize",!0),("border-box"===f.css("box-sizing")||"border-box"===f.css("-moz-box-sizing")||"border-box"===f.css("-webkit-box-sizing"))&&(p=f.outerHeight()-f.height()),d=Math.max(parseInt(f.css("minHeight"),10)-p||0,f.height()),f.css({overflow:"hidden",overflowY:"hidden",wordWrap:"break-word",resize:"none"===f.css("resize")||"vertical"===f.css("resize")?"none":"horizontal"}),"onpropertychange"in h?"oninput"in h?f.on("input.autosize keyup.autosize",r):f.on("propertychange.autosize",function(){"value"===event.propertyName&&r()}):f.on("input.autosize",r),i.resizeDelay!==!1&&t(window).on("resize.autosize",l),f.on("autosize.resize",r),f.on("autosize.resizeIncludeStyle",function(){e=null,r()}),f.on("autosize.destroy",function(){e=null,clearTimeout(u),t(window).off("resize",l),f.off("autosize").off(".autosize").css(w).removeData("autosize")}),r())})):this}}(jQuery),$.fn.sshare=function(t){if(!this.find(".sn-share-btns").length){var e={trigger:"hover",duration:"fast",text:void 0,url:"http://vempraruavem.org"},t=$.extend($.extend(e,this.data()),t),o={twitter:function(){if(!t.text&&!t.url)throw"No url or text specified";var e="http://twitter.com/share?"+(t.text&&"&text="+encodeURIComponent(t.text))||"url="+encodeURIComponent(t.url);window.open(e,"","width=500,height=350,toolbar=0,menubar=0,location=0","modal=yes")},facebook:function(){if(!t.url)throw"No url or text specified";var e="http://www.facebook.com/sharer.php?u="+encodeURIComponent(t.url);window.open(e,"","width=500,height=350,toolbar=0,menubar=0,location=0","modal=yes")},gplus:function(){if(!t.url)throw"No url or text specified";var e="https://plusone.google.com/_/+1/confirm?hl=pt&url="+encodeURIComponent(t.url);window.open(e,"","width=500,height=350,toolbar=0,menubar=0,location=0","modal=yes")}};this.addClass("sn-share");var i=$('<div class="sn-share-btns"><div class="btn-group"><button class="btn btn-xs btn-info btn-twitter"><i class="fa fa-twitter"></i></button><button class="btn btn-xs btn-info btn-facebook">&nbsp;<i class="fa fa-facebook"></i>&nbsp;</button><button class="btn btn-xs btn-info btn-gplus"><i class="fa fa-google-plus"></i></button></div><div class="arrow"></div></div>');i.find(".btn-twitter").click(o.twitter),i.find(".btn-facebook").click(o.facebook),i.find(".btn-gplus").click(o.gplus),i.appendTo(this),this.click(function(t){return t.stopPropagation(),t.preventDefault(),!1}),t.now===!0?(i.fadeIn(),this.on("click "+("hover"===t.trigger?"mouseenter":""),function(){i.fadeIn(t.duration)})):this.on("click "+("hover"===t.trigger?"mouseenter":""),function(){i.fadeIn(t.duration)}),this.on("mouseleave",function(){i.fadeOut(t.duration)})}},$.fn.xdialog=function(){if(this[0]){var t=this[0].hash||"#"+this[0].dataset.hash,e=$(t),o=!!this.data("hide-url");this.click(function(i){i.preventDefault(),e.addClass("active"),o||history.pushState({},"",t)}),e.find("[data-action=close-dialog]").click(function(t){return t.preventDefault(),console.log("clicked"),e.removeClass("active"),o||(location.hash=""),!1})}},module.exports=$;
},{"jquery":23}],13:[function(require,module,exports){
module.exports=function(){$("[data-action=edit-profile]").click(function(){$(".profileWrapper").addClass("editing")}),$("[name=name1], [name=name2]").on("keydown",function(e){32==e.keyCode&&e.preventDefault()}),$(".autosize").autosize(),$("[data-action=save-profile]").click(function(){var e={bio:$("[name=bio]").val(),nome1:$("[name=name1]").val(),nome2:$("[name=name2]").val(),home:$("[name=home]").val(),location:$("[name=location]").val()};$.ajax({type:"PUT",dataType:"JSON",url:"/api/me/profile",data:{profile:e}}).done(function(e){if(e.error)e.message?app.flash.alert(e.message):console.warn("????",e);else if(e.data){var a=e.data;$(".profileWrapper").removeClass("editing"),$(".profileOutput.bio").html(a.profile.bio),$(".profileOutput.name").html(a.name),$(".profileOutput.home").html(a.profile.home),$(".profileOutput.location").html(a.profile.location)}else app.flash.alert("Um erro pode ter ocorrido.")}).fail(function(){})})};
},{}],14:[function(require,module,exports){
var $=require("jquery");window.$=window.jQuery=$,require("backbone");var common=require("../common.js"),router=require("../components/router.js");router.initialize();
},{"../common.js":1,"../components/router.js":7,"backbone":18,"jquery":23}],15:[function(require,module,exports){
!function(e){e.fn.mediumInsert.registerAddon("images",{init:function(t){t&&t.$el&&(this.$el=t.$el),this.options=e.extend(this.default,t),this.setImageEvents(),this.preparePreviousImages()},insertButton:function(e){var t="Img";return"fontawesome"==e&&(t='<i class="fa fa-picture-o"></i>'),'<button data-addon="images" data-action="add" class="medium-editor-action medium-editor-action-image mediumInsert-action">'+t+"</button>"},"default":{imagesUploadScript:"upload.php",formatData:function(e){var t=new FormData;return t.append("file",e),t}},preparePreviousImages:function(){this.$el.find(".mediumInsert-images").each(function(){var t=e(this).parent();t.html('<div class="mediumInsert-placeholder" draggable="true">'+t.html()+"</div>")})},add:function(t){function s(e){return e.replace(/($\s+)|(\s+^)/g,"")}var i,n=s(prompt("Insira a url da imagem que você deseja usar."));return t.append('<progress class="progress" min="0" max="100" value="0">0</progress>'),this.selectCompleted(n,t),e.fn.mediumInsert.insert.deselect(),i},updateProgressBar:function(t){var s,i=e(".progress:first",this.$el);t.lengthComputable&&(s=t.loaded/t.total*100|0,i.attr("value",s),i.html(s))},selectCompleted:function(t,s){var i,n=e(s.find(".progress")[0]);n.attr("value",100),n.html(100),n.before('<div class="mediumInsert-images"><img src="'+t+'" draggable="true" alt=""></div>'),i=n.siblings("img"),n.remove(),i.parent().mouseleave().mouseenter(),i.load(function(){console.log("did load")}),e.fn.mediumInsert.insert.$el.keyup()},setImageEvents:function(){this.$el.on("mouseenter",".mediumInsert-images",function(){var t,s,i=e("img",this);e.fn.mediumInsert.settings.enabled!==!1&&i.length>0&&(e(this).append('<a class="mediumInsert-imageRemove"></a>'),t=i.position().top+parseInt(i.css("margin-top"),10),s=i.position().left+i.width()-30,e(".mediumInsert-imageRemove",this).css({right:"auto",top:t,left:s}))}),this.$el.on("mouseleave",".mediumInsert-images",function(){e(".mediumInsert-imageRemove, .mediumInsert-imageResizeSmaller, .mediumInsert-imageResizeBigger",this).remove()}),this.$el.on("click",".mediumInsert-imageResizeSmaller",function(){e(this).parent().parent().parent().addClass("small"),e(this).parent().mouseleave().mouseleave(),e.fn.mediumInsert.insert.deselect()}),this.$el.on("click",".mediumInsert-imageResizeBigger",function(){e(this).parent().parent().parent().removeClass("small"),e(this).parent().mouseleave().mouseleave(),e.fn.mediumInsert.insert.deselect()}),this.$el.on("click",".mediumInsert-imageRemove",function(){0===e(this).parent().siblings().length&&e(this).parent().parent().parent().removeClass("small"),e(this).parent().remove(),e.fn.mediumInsert.insert.deselect()})}})}(jQuery);
...
var $=require("jquery");window.$=$;var MediumEditor=require("./addons/medium-editor.min.js");window.MediumEditor=MediumEditor,require("./addons/medium-editor-insert-plugin.min.js"),require("./addons/medium-editor-insert-images-modified.js"),module.exports=MediumEditor;
...
!function(e,t,n){function r(e,t){return typeof e===t}function a(){var e,t,n,a,o,i,s,c;for(c in b){if(e=[],t=b[c],t.name&&(e.push(t.name.toLowerCase()),t.options&&t.options.aliases&&t.options.aliases.length))for(n=0;t.options.aliases.length>n;n++)e.push(t.options.aliases[n].toLowerCase());for(a=r(t.fn,"function")?t.fn():t.fn,o=0;e.length>o;o++)i=e[o],s=i.split("."),1===s.length?x[s[0]]=a:2===s.length&&(!x[s[0]]||x[s[0]]instanceof Boolean||(x[s[0]]=new Boolean(x[s[0]])),x[s[0]][s[1]]=a),y.push((a?"":"no-")+s.join("-"))}}function o(e){var t,n,r;t=C.className,n=x._config.classPrefix||"",r=RegExp("(^|\\s)"+n+"no-js(\\s|$)"),t=t.replace(r,"$1"+n+"js$2"),x._config.enableClasses&&(t+=" "+n+e.join(" "+n),C.className=t)}function i(e,t){var r,a,s;if("object"==typeof e)for(r in e)S(e,r)&&i(r,e[r]);else{if(e=e.toLowerCase(),a=e.split("."),s=x[a[0]],2==a.length&&(s=s[a[1]]),s!==n)return x;t="function"==typeof t?t():t,1==a.length?x[a[0]]=t:2==a.length&&(!x[a[0]]||x[a[0]]instanceof Boolean||(x[a[0]]=new Boolean(x[a[0]])),x[a[0]][a[1]]=t),o([(t?"":"no-")+a.join("-")]),x._trigger(e,t)}return x}function s(e){return e.replace(/([a-z])-([a-z])/g,function(e,t,n){return t+n.toUpperCase()}).replace(/^-/,"")}function c(e,t){return!!~(""+e).indexOf(t)}function l(){var e=t.body;return e||(e=P("body"),e.fake=!0),e}function d(e,t,n,r){var a,o,i,s,c,d,u;if(a="modernizr",d=P("div"),u=l(),parseInt(n,10))for(;n--;)s=P("div"),s.id=r?r[n]:a+(n+1),d.appendChild(s);return o=["­",'<style id="s',a,'">',e,"</style>"].join(""),d.id=a,(u.fake?u:d).innerHTML+=o,u.appendChild(d),u.fake&&(u.style.background="",u.style.overflow="hidden",c=C.style.overflow,C.style.overflow="hidden",C.appendChild(u)),i=t(d,e),u.fake?(u.parentNode.removeChild(u),C.style.overflow=c,C.offsetHeight):d.parentNode.removeChild(d),!!i}function u(e,t){return function(){return e.apply(t,arguments)}}function f(e,t,n){var a,o;for(o in e)if(e[o]in t)return n===!1?e[o]:(a=t[e[o]],r(a,"function")?u(a,n||t):a);return!1}function p(e){return e.replace(/([A-Z])/g,function(e,t){return"-"+t.toLowerCase()}).replace(/^ms-/,"-ms-")}function m(t,r){var a,o;if(a=t.length,"CSS"in e&&"supports"in e.CSS){for(;a--;)if(e.CSS.supports(p(t[a]),r))return!0;return!1}if("CSSSupportsRule"in e){for(o=[];a--;)o.push("("+p(t[a])+":"+r+")");return o=o.join(" or "),d("@supports ("+o+") { #modernizr { position: absolute; } }",function(t){return"absolute"==(e.getComputedStyle?getComputedStyle(t,null):t.currentStyle).position})}return n}function g(e,t,a,o){function i(){l&&(delete I.style,delete I.modElem)}var s,l,d,u,f;if(o=r(o,"undefined")?!1:o,!r(a,"undefined")&&(s=m(e,a),!r(s,"undefined")))return s;I.style||(l=!0,I.modElem=P("modernizr"),I.style=I.modElem.style);for(d in e)if(u=e[d],f=I.style[u],!c(u,"-")&&I.style[u]!==n){if(o||r(a,"undefined"))return i(),"pfx"==t?u:!0;try{I.style[u]=a}catch(p){}if(I.style[u]!=f)return i(),"pfx"==t?u:!0}return i(),!1}function h(e,t,n,a,o){var i=e.charAt(0).toUpperCase()+e.slice(1),s=(e+" "+j.join(i+" ")+i).split(" ");return r(t,"string")||r(t,"undefined")?g(s,t,a,o):(s=(e+" "+E.join(i+" ")+i).split(" "),f(s,t,n))}function v(e,t,r){return h(e,n,n,t,r)}var y,b,T,x,w,C,S,k,E,P,_,$,A,z,N,R,B,L,M,j,F,O,D,I,H,q,W,G;y=[],function(e,t){function r(e,t){var n=e.createElement("p"),r=e.getElementsByTagName("head")[0]||e.documentElement;return n.innerHTML="x<style>"+t+"</style>",r.insertBefore(n.lastChild,r.firstChild)}function a(){var e=b.elements;return"string"==typeof e?e.split(" "):e}function o(e){var t=v[e[g]];return t||(t={},h++,e[g]=h,v[h]=t),t}function i(e,n,r){if(n||(n=t),y)return n.createElement(e);r||(r=o(n));var a;return a=r.cache[e]?r.cache[e].cloneNode():p.test(e)?(r.cache[e]=r.createElem(e)).cloneNode():r.createElem(e),!a.canHaveChildren||f.test(e)||a.tagUrn?a:r.frag.appendChild(a)}function s(e,n){if(e||(e=t),y)return e.createDocumentFragment();n=n||o(e);for(var r=n.frag.cloneNode(),i=0,s=a(),c=s.length;c>i;i++)r.createElement(s[i]);return r}function c(e,t){t.cache||(t.cache={},t.createElem=e.createElement,t.createFrag=e.createDocumentFragment,t.frag=t.createFrag()),e.createElement=function(n){return b.shivMethods?i(n,e,t):t.createElem(n)},e.createDocumentFragment=Function("h,f","return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&("+a().join().replace(/[\w\-:]+/g,function(e){return t.createElem(e),t.frag.createElement(e),'c("'+e+'")'})+");return n}")(b,t.frag)}function l(e){e||(e=t);var n=o(e);return!b.shivCSS||m||n.hasCSS||(n.hasCSS=!!r(e,"article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")),y||c(e,n),e}var d,u,f,p,m,g,h,v,y,b;d="3.7.0",u=e.html5||{},f=/^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i,p=/^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i,g="_html5shiv",h=0,v={},function(){try{var e=t.createElement("a");e.innerHTML="<xyz></xyz>",m="hidden"in e,y=1==e.childNodes.length||function(){t.createElement("a");var e=t.createDocumentFragment();return e.cloneNode===n||e.createDocumentFragment===n||e.createElement===n}()}catch(r){m=!0,y=!0}}(),b={elements:u.elements||"abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output picture progress section summary template time video",version:d,shivCSS:u.shivCSS!==!1,supportsUnknownElements:y,shivMethods:u.shivMethods!==!1,type:"default",shivDocument:l,createElement:i,createDocumentFragment:s},e.html5=b,l(t)}(this,t),b=[],T={_version:"v3.0.0pre",_config:{classPrefix:"",enableClasses:!0,usePrefixes:!0},_q:[],on:function(e,t){setTimeout(function(){t(this[e])},0)},addTest:function(e,t,n){b.push({name:e,fn:t,options:n})},addAsyncTest:function(e){b.push({name:null,fn:e})}},x=function(){},x.prototype=T,x=new x,x.addTest("applicationcache","applicationCache"in e),x.addTest("geolocation","geolocation"in navigator),x.addTest("history",function(){var t=navigator.userAgent;return-1===t.indexOf("Android 2.")&&-1===t.indexOf("Android 4.0")||-1===t.indexOf("Mobile Safari")||-1!==t.indexOf("Chrome")?e.history&&"pushState"in e.history:!1}),x.addTest("localstorage",function(){var e="modernizr";try{return localStorage.setItem(e,e),localStorage.removeItem(e),!0}catch(t){return!1}}),x.addTest("postmessage","postMessage"in e),x.addTest("sessionstorage",function(){var e="modernizr";try{return sessionStorage.setItem(e,e),sessionStorage.removeItem(e),!0}catch(t){return!1}}),x.addTest("svg",!!t.createElementNS&&!!t.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect),x.addTest("websqldatabase","openDatabase"in e),x.addTest("webworkers","Worker"in e),x.addTest("websockets","WebSocket"in e&&2===e.WebSocket.CLOSING),w=T._config.usePrefixes?" -webkit- -moz- -o- -ms- ".split(" "):[],T._prefixes=w,C=t.documentElement,function(){var e={}.hasOwnProperty;S=r(e,"undefined")||r(e.call,"undefined")?function(e,t){return t in e&&r(e.constructor.prototype[t],"undefined")}:function(t,n){return e.call(t,n)}}(),T._l={},T.on=function(e,t){this._l[e]||(this._l[e]=[]),this._l[e].push(t),x.hasOwnProperty(e)&&setTimeout(function(){x._trigger(e,x[e])},0)},T._trigger=function(e,t){if(this._l[e]){var n=this._l[e];setTimeout(function(){var e,r;for(e=0;n.length>e;e++)(r=n[e])(t)},0),delete this._l[e]}},x._q.push(function(){T.addTest=i}),k="Webkit Moz O ms",E=T._config.usePrefixes?k.toLowerCase().split(" "):[],T._domPrefixes=E,P=function(){return t.createElement.apply(t,arguments)},x.addTest("canvas",function(){var e=P("canvas");return!(!e.getContext||!e.getContext("2d"))}),x.addTest("canvastext",function(){return x.canvas===!1?!1:"function"==typeof P("canvas").getContext("2d").fillText}),x.addTest("cssgradients",function(){var e,t,n,r,a,o;return e="background-image:",t="gradient(linear,left top,right bottom,from(#9f9),to(white));",n="linear-gradient(left top,#9f9, white);",r=e+w.join(n+e).slice(0,-e.length),x._config.usePrefixes&&(r+=e+"-webkit-"+t),a=P("div"),o=a.style,o.cssText=r,(""+o.backgroundImage).indexOf("gradient")>-1}),x.addTest("multiplebgs",function(){var e,t;return e=P("div"),t=e.style,t.cssText="background:url(https://),url(https://),red url(https://)",/(url\s*\(.*?){3}/.test(t.background)}),x.addTest("opacity",function(){var e,t;return e=P("div"),t=e.style,t.cssText=w.join("opacity:.55;"),/^0.55$/.test(t.opacity)}),x.addTest("rgba",function(){var e,t;return e=P("div"),t=e.style,t.cssText="background-color:rgba(150,255,150,.5)",(""+t.backgroundColor).indexOf("rgba")>-1}),x.addTest("draganddrop",function(){var e=P("div");return"draggable"in e||"ondragstart"in e&&"ondrop"in e}),x.addTest("audio",function(){var e,t;e=P("audio"),t=!1;try{(t=!!e.canPlayType)&&(t=new Boolean(t),t.ogg=e.canPlayType('audio/ogg; codecs="vorbis"').replace(/^no$/,""),t.mp3=e.canPlayType("audio/mpeg;").replace(/^no$/,""),t.opus=e.canPlayType('audio/ogg; codecs="opus"').replace(/^no$/,""),t.wav=e.canPlayType('audio/wav; codecs="1"').replace(/^no$/,""),t.m4a=(e.canPlayType("audio/x-m4a;")||e.canPlayType("audio/aac;")).replace(/^no$/,""))}catch(n){}return t}),x.addTest("video",function(){var e,t;e=P("video"),t=!1;try{(t=!!e.canPlayType)&&(t=new Boolean(t),t.ogg=e.canPlayType('video/ogg; codecs="theora"').replace(/^no$/,""),t.h264=e.canPlayType('video/mp4; codecs="avc1.42E01E"').replace(/^no$/,""),t.webm=e.canPlayType('video/webm; codecs="vp8, vorbis"').replace(/^no$/,""),t.vp9=e.canPlayType('video/webm; codecs="vp9"').replace(/^no$/,""),t.hls=e.canPlayType('application/x-mpegURL; codecs="avc1.42E01E"').replace(/^no$/,""))}catch(n){}return t}),x.addTest("inlinesvg",function(){var e=P("div");return e.innerHTML="<svg/>","http://www.w3.org/2000/svg"==(e.firstChild&&e.firstChild.namespaceURI)}),x.addTest("webgl",function(){var t=P("canvas");return"supportsContext"in t?t.supportsContext("webgl")||t.supportsContext("experimental-webgl"):!!e.WebGLRenderingContext}),_=function(e){function n(t,n){var a;return t?(n&&"string"!=typeof n||(n=P(n||"div")),t="on"+t,a=t in n,!a&&r&&(n.setAttribute||(n=P("div")),n.setAttribute&&n.removeAttribute&&(n.setAttribute(t,""),a="function"==typeof n[t],n[t]!==e&&(n[t]=e),n.removeAttribute(t))),a):!1}var r=!("onblur"in t.documentElement);return n}(),$=T.hasEvent=_,x.addTest("hashchange",function(){return $("hashchange",e)===!1?!1:t.documentMode===n||t.documentMode>7}),x.addTest("hsla",function(){var e,t;return e=P("div"),t=e.style,t.cssText="background-color:hsla(120,40%,100%,.5)",c(t.backgroundColor,"rgba")||c(t.backgroundColor,"hsla")}),A=P("input"),z="search tel url email datetime date month week time datetime-local number range color".split(" "),N={},R=":)",x.inputtypes=function(e){var r,a,o,i,s;for(i=e.length,s=0;i>s;s++)A.setAttribute("type",a=e[s]),r="text"!==A.type,r&&(A.value=R,A.style.cssText="position:absolute;visibility:hidden;",/^range$/.test(a)&&A.style.WebkitAppearance!==n?(C.appendChild(A),o=t.defaultView,r=o.getComputedStyle&&"textfield"!==o.getComputedStyle(A,null).WebkitAppearance&&0!==A.offsetHeight,C.removeChild(A)):/^(search|tel)$/.test(a)||(r=/^(url|email)$/.test(a)?A.checkValidity&&A.checkValidity()===!1:A.value!=R)),N[e[s]]=!!r;return N}(z),B={},L="autocomplete autofocus list placeholder max min multiple pattern required step".split(" "),x.input=function(t){for(var n=0,r=t.length;r>n;n++)B[t[n]]=!!(t[n]in A);return B.list&&(B.list=!(!P("datalist")||!e.HTMLDataListElement)),B}(L),M={}.toString,x.addTest("svgclippaths",function(){return!!t.createElementNS&&/SVGClipPath/.test(M.call(t.createElementNS("http://www.w3.org/2000/svg","clipPath")))}),x.addTest("smil",function(){return!!t.createElementNS&&/SVGAnimate/.test(M.call(t.createElementNS("http://www.w3.org/2000/svg","animate")))}),j=T._config.usePrefixes?k.split(" "):[],T._cssomPrefixes=j,F=T.testStyles=d,O=function(){var e,t,n,r,a;return e=navigator.userAgent,t=e.match(/applewebkit\/([0-9]+)/gi)&&parseFloat(RegExp.$1),n=e.match(/w(eb)?osbrowser/gi),r=e.match(/windows phone/gi)&&e.match(/iemobile\/([0-9])+/gi)&&parseFloat(RegExp.$1)>=9,a=533>t&&e.match(/android/gi),n||a||r}(),O?x.addTest("fontface",!1):F('@font-face {font-family:"font";src:url("https://")}',function(e,n){var r,a,o,i;r=t.getElementById("smodernizr"),a=r.sheet||r.styleSheet,o=a?a.cssRules&&a.cssRules[0]?a.cssRules[0].cssText:a.cssText||"":"",i=/src/i.test(o)&&0===o.indexOf(n.split(" ")[0]),x.addTest("fontface",i)}),F('#modernizr{font:0/0 a}#modernizr:after{content:":)";visibility:hidden;font:7px/1 a}',function(e){x.addTest("generatedcontent",e.offsetHeight>=7)}),D={elem:P("modernizr")},x._q.push(function(){delete D.elem}),I={style:D.elem.style},x._q.unshift(function(){delete I.style}),H=T.testProp=function(e,t,r){return g([e],n,t,r)},x.addTest("textshadow",H("textShadow","1px 1px")),T.testAllProps=h,q=T.prefixed=function(e,t,n){return-1!=e.indexOf("-")&&(e=s(e)),t?h(e,t,n):h(e,"pfx")},W=q("indexedDB",e),x.addTest("indexeddb",!!W),W&&x.addTest("indexeddb.deletedatabase","deleteDatabase"in W),T.testAllProps=v,x.addTest("backgroundsize",v("backgroundSize","100%",!0)),x.addTest("borderimage",v("borderImage","url() 1",!0)),x.addTest("borderradius",v("borderRadius","0px",!0)),x.addTest("boxshadow",v("boxShadow","1px 1px",!0)),x.addTest("cssanimations",v("animationName","a",!0)),function(){var e,t,n,r;for(x.addTest("csscolumns",function(){var e,t;e=!1,t=v("columnCount");try{(e=!!t)&&(e=new Boolean(e))}catch(n){}return e}),e=["Width","Span","Fill","Gap","Rule","RuleColor","RuleStyle","RuleWidth","BreakBefore","BreakAfter","BreakInside"],r=0;e.length>r;r++)t=e[r].toLowerCase(),n=v("column"+e[r]),("breakbefore"===t||"breakafter"===t||"breakinside"==t)&&(n=n||v(e[r])),x.addTest("csscolumns."+t,n)}(),x.addTest("cssreflections",v("boxReflect","above",!0)),x.addTest("csstransforms",v("transform","scale(1)",!0)),x.addTest("csstransforms3d",function(){var e,t,n;return e=!!v("perspective","1px",!0),t=x._config.usePrefixes,e&&(!t||"webkitPerspective"in C.style)&&(n="@media (transform-3d)",t&&(n+=",(-webkit-transform-3d)"),n+="{#modernizr{left:9px;position:absolute;height:5px;margin:0;padding:0;border:0}}",F(n,function(t){e=9===t.offsetLeft&&5===t.offsetHeight})),e}),x.addTest("csstransitions",v("transition","all",!0)),x.addTest("flexbox",v("flexBasis","1px",!0)),x.addTest("flexboxlegacy",v("boxDirection","reverse",!0)),a(),o(y),delete T.addTest,delete T.addAsyncTest;for(G=0;x._q.length>G;G++)x._q[G]();e.Modernizr=x}(this,document);
...
//# sourceMappingURL=bundle.min.map.json;